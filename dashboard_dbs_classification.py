...
# Usage: RESULTS_PATH=/path/to/local/results streamlit run dashboard_dbs_classification.py
...
logger.info("DBS Classification Dashboard script started.")

st.set_page_config(layout="wide")

st.title("DBS Classification Dashboard")
