...
# Usage: RESULTS_PATH=/path/to/local/results streamlit run dashboard_time_series_trial.py
...
from dashboard.time_series_tab import (
    render_neural_tab,
    render_behavioral_tab,
    render_cross_trial_analysis,
...
logger.info("Time-Series Trial Level Dashboard script started.")

st.set_page_config(layout="wide")

st.title("Time-Series Analysis - Trial Level")
