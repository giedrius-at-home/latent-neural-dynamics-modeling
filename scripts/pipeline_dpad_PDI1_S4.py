#!/usr/bin/env python3
"""
DPAD pipeline for PDI1 Session 4 (200 Hz narrow-band data).
...
Usage:
    python scripts/pipeline_dpad_PDI1_S4.py 2>&1 | tee dpad_PDI1_S4.log
"""
...
# ── Logging ───────────────────────────────────────────────────────────────────
LOG_PATH = PROJECT_ROOT / "dpad_PDI1_S4.log"
logging.basicConfig(
    level=logging.INFO,
