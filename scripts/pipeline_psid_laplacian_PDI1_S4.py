#!/usr/bin/env python3
"""
PSID pipeline for PDI1 Session 4 — Laplacian LFP (200 Hz narrow-band).
...
Usage:
    python scripts/pipeline_psid_laplacian_PDI1_S4.py 2>&1 | tee psid_lap_PDI1_S4.log
"""
...
# ── Logging ───────────────────────────────────────────────────────────────────
LOG_PATH = PROJECT_ROOT / "psid_lap_PDI1_S4.log"
logging.basicConfig(
    level=logging.INFO,
