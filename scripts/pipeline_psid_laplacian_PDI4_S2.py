#!/usr/bin/env python3
"""
PSID pipeline for PDI4 Session 2 — Laplacian LFP (200 Hz narrow-band).
...
Usage:
    python scripts/pipeline_psid_laplacian_PDI4_S2.py 2>&1 | tee psid_lap_PDI4_S2.log
"""
...
# ── Logging ───────────────────────────────────────────────────────────────────
LOG_PATH = PROJECT_ROOT / "psid_lap_PDI4_S2.log"
logging.basicConfig(
    level=logging.INFO,
