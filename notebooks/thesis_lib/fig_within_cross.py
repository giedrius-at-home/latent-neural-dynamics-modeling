...
from thesis_lib.aggregate_rmse import WithinCrossRmseData
...
def plot_within_cross_figures(save: bool = True) -> None:
    """Generate Part A and Part B figures; save to thesis_lib/figures/."""
    import logging
    from thesis_lib.plot_config import RESULTS_ROOT
    from thesis_lib.specs import THESIS_WITHIN_CROSS
