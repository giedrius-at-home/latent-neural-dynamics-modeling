...
# Usage: RESULTS_PATH=/path/to/local/results streamlit run dashboard_model_predictions.py
...
logger.info("Model Predictions Dashboard script started.")

st.set_page_config(layout="wide")

st.title("Model Predictions Dashboard")
